...
from app.design.geometry.adjacency import build_connections
...
def build(output_path=None):
    ...
    json_path = Path(output_path) if output_path is not None else Path(__file__).resolve().parents[3] / 'HousePlanner.API' / 'Data' / 'Seed' / 'pre-designed-plans.json'
